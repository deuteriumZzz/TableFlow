...
class Order(models.Model):
    ...
    table = models.ForeignKey('tables.Table', on_delete=models.SET_NULL, null=True, blank=True, verbose_name=_("Стол"))
    user = models.ForeignKey('accounts.User', on_delete=models.SET_NULL, null=True, blank=True, verbose_name=_("Пользователь"))
    waitress = models.ForeignKey('accounts.User', related_name='orders_as_waitress', on_delete=models.SET_NULL, null=True, blank=True, verbose_name=_("Официант"))
    ...
    total_amount = models.DecimalField(max_digits=10, decimal_places=2, default=0, verbose_name=_("Итоговая сумма"))
    discount = models.DecimalField(max_digits=10, decimal_places=2, default=0, verbose_name=_("Скидка"))
    tax = models.DecimalField(max_digits=10, decimal_places=2, default=0, verbose_name=_("Налог"))
...
class OrderItem(models.Model):
    ...
    product = models.ForeignKey('menu.Product', on_delete=models.SET_NULL, null=True, verbose_name=_("Товар"))
    ...
    modifiers = models.ManyToManyField('menu.Modifier', through='OrderItemModifier', blank=True, verbose_name=_("Модификаторы"))
